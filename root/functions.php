...
foreach ($rows as $row) {
    ...
    echo '<span><a href="products/' .
        $row["link"] .
        '.php"><img src="images/searchresult/' .
        $row["image"] .
        '.jpg" class="searchresultimage"></a></span>';
    ...
    echo '<span class="cta"><h2><a href="products/' .
        $row["link"] .
        '.php"><button>Add to Cart</button></a><span><h2>';
